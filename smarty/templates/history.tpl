...
<script type="text/javascript" src="jquery.datepick.package/js/jquery.datepick.js"></script>
...
{/block}
{block name="css"}
<link rel="stylesheet" type="text/css" href="jquery.datepick.package/jquery.datepick.css" />
