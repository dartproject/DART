...
class Privileges {
    ...
    CONST USER_RECORDS_SEARCH_VIEW_EXPORT   = 'A67108864';          //A27
    ...
    public static function check($uPrivilege, $privilege){
        if(isset($uPrivilege[substr($privilege,0,1)])){
            return((int)$uPrivilege[substr($privilege,0,1)]->getValue() & (int)substr($privilege,1,strlen($privilege)));
        }
        else
            return false;
    } 
